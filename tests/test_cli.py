...
def cli_help() -> str:
    """The `--help` output, with any color argparse added stripped back out.

    Python 3.14 colorizes argparse help, so the text carries escapes that sit between `--format`
    ...
    tests read the help with them removed rather than turning the color off.
