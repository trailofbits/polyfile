    ...
    * <https://github.com/libexif/libexif-testsuite/tree/8c1f5bbc18d2cbc80b01b3f9b3eb29546310acf2> (15/18 .jpg)
    ...
    class ExifBody(KaitaiStruct):
        ...
        def _read_le(self):
            ...
            self._debug['ofs_ifd0']['start'] = self._io.pos()
            self.ofs_ifd0 = self._io.read_u4le()
            self._debug['ofs_ifd0']['end'] = self._io.pos()
        ...
        class Ifd(KaitaiStruct):
            SEQ_FIELDS = ["num_fields", "fields", "ofs_next_ifd"]
            ...
            def _read_le(self):
                ...
                self._debug['ofs_next_ifd']['start'] = self._io.pos()
                self.ofs_next_ifd = self._io.read_u4le()
                self._debug['ofs_next_ifd']['end'] = self._io.pos()
        ...
        class IfdField(KaitaiStruct):
            SEQ_FIELDS = ["tag_raw", "field_type", "num_values", "ofs_data"]
            def __init__(self, _io, _parent=None, _root=None, _is_le=None):
            ...
            def _read_le(self):
                ...
                self._debug['num_values']['start'] = self._io.pos()
                self.num_values = self._io.read_u4le()
                self._debug['num_values']['end'] = self._io.pos()
        ...
        class Rational(KaitaiStruct):
            SEQ_FIELDS = ["value_num", "value_den"]
            def __init__(self, _io, _parent=None, _root=None, _is_le=None):
            ...
            def _read_le(self):
                self._debug['value_num']['start'] = self._io.pos()
                self.value_num = self._io.read_u4le()
                self._debug['value_num']['end'] = self._io.pos()
                self._debug['value_den']['start'] = self._io.pos()
                self.value_den = self._io.read_u4le()
                self._debug['value_den']['end'] = self._io.pos()
